...
class SaveShiftReportController extends Controller
{
    ...
    public function __invoke(CreateShiftReportRequest $request)
    {
        ...
        // Scoped to the reporting user's own assignment row. Matching on the
        // shift and date alone would hand back someone else's row, letting any
        // volunteer file a report against a shift they never worked — and,
        // because a shift accepts only one report, lock out the people who did.
