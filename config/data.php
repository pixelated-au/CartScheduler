...
use Spatie\LaravelData\Transformers;
use Spatie\LaravelData\Normalizers;
use Spatie\LaravelData\RuleInferrers;
...
return [
     ...
     */
    'transformers' => [
        DateTimeInterface::class => Transformers\DateTimeInterfaceTransformer::class,
        Arrayable::class => Transformers\ArrayableTransformer::class,
        BackedEnum::class => Transformers\EnumTransformer::class,
    ],
     ...
     */
    'casts' => [
        DateTimeInterface::class => Casts\DateTimeInterfaceCast::class,
        BackedEnum::class => Casts\EnumCast::class,
//        Enumerable::class => Casts\EnumerableCast::class,
    ],
     ...
     */
    'rule_inferrers' => [
        RuleInferrers\SometimesRuleInferrer::class,
        RuleInferrers\NullableRuleInferrer::class,
        RuleInferrers\RequiredRuleInferrer::class,
        RuleInferrers\BuiltInTypesRuleInferrer::class,
        RuleInferrers\AttributesRuleInferrer::class,
    ],
     ...
     */
    'normalizers' => [
        Normalizers\ModelNormalizer::class,
        Normalizers\FormRequestNormalizer::class,
        Normalizers\ArrayableNormalizer::class,
        Normalizers\ObjectNormalizer::class,
        Normalizers\ArrayNormalizer::class,
        Normalizers\JsonNormalizer::class,
    ],
