    ...
    <JetActionSection>
        ...
        <template #content>
            ...
            <h3 v-else-if="twoFactorEnabled && confirming" class="text-lg font-medium text-gray-900 dark:text-gray-100">
                Finish enabling two factor authentication. </h3>
                ...
                <div v-if="qrCode">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        ...
                        <p v-else>
                            ...
                            authenticator application or enter the setup key. </p>
                    </div>
                ...
                <div v-if="recoveryCodes.length > 0 && ! confirming">
                    <div class="mt-4 max-w-xl text-sm text-gray-600">
                        <p class="font-semibold">
                            ...
                            to your account if your two factor authentication device is lost. </p>
                    </div>
