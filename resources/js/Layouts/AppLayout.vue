...
<template>
  ...
  <ObtrusiveNotification :draggable="false" :close-on-escape="false" :closable="false" block-scroll full-screen-on-mobile v-model="showUpdateAvailabilityReminder" class="md:max-w-lg">
    <div class="p-6 text-center dark:text-gray-100">
      ...
      <div class="flex flex-col justify-between w-full">
        ...
        <PButton severity="secondary" outline class="justify-center text-center" @click="checkLater">I'll
          check later
        </PButton>
