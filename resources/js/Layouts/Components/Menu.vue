...
<template>
  <PMenubar
      ...
      class="max-sm:[&_.p-menubar-root-list]:w-auto max-sm:[&_.p-menubar-root-list]:bg-[radial-gradient(rgba(0,0,0,.8)_0%,transparent_30%)] max-sm:[&_.p-menubar-root-list]:bg-[position:50%_calc(135%)] max-sm:[&_.p-menubar-root-list]:bg-[size:500%_200%] max-sm:[&_.p-menubar-root-list]:bg-[no-repeat] max-sm:[&_.p-menubar-root-list]:inset-x-0 max-sm:[&_.p-menubar-root-list]:mx-3 max-sm:[&_.p-menubar-root-list]:rounded-t-none bg-panel dark:bg-panel-dark">
    <template #start>
